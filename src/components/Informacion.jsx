...
const Informacion = ({ informacion }) => {
    ...
    const { strArtistThumb, strFacebook, strTwitter, strLastFMChart, strGenre, strBiographyES } = informacion;

    return (
        <div className="card border-light">
            <div className="card-header bg-primary text-light font-weight-bold">Información del artista</div>
